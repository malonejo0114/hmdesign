# 운명코드 MVP (Human Design)

Human Design 기반 개인화 리딩 SaaS의 웹 MVP입니다. 브랜드 컨셉은 **운명코드**이며, 다크 우주 테마 + 한국어 친화 리포트를 기본 톤으로 사용합니다.
...
- SVG 바디그래프 형태 미리보기(히어로/결과 영역)
- 10페이지 구성의 리포트 목차 카드(8~12p 요구 대응)
- 궁합 분석 입력/결과
- 목표 기반 코칭 입력/결과
